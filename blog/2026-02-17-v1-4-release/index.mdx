...
DMS is available for Arch Linux, Fedora, openSUSE, Debian, Ubuntu, CentOS, NixOS, Gentoo, and more. Gentoo users have two community overlays to choose from: [quilat-overlay](https://github.com/Graght/quilat-overlay) (live ebuild tracking git master, with OpenRC + systemd support) and [tdgentoo](https://github.com/timdodge/tdgentoo) (versioned ebuild pinned to stable releases).

See the [installation guide](/docs/getting-started) for setup instructions.

## Upgrade Notes

There are no notable upgrade notes for this release or breaking changes.
