...
Screenshot functionality for the Niri compositor. Captures are opened in Swappy for markup and annotation.
...
**Requirements:** Niri compositor and Swappy must be installed.
