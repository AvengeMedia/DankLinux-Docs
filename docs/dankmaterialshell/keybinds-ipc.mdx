...
Hyprland-specific controls including keybinds cheatsheet and workspace overview.

| Function | Description |
| --- | --- |
| `openBinds` | Show Hyprland keybinds cheatsheet modal |
| `closeBinds` | Hide Hyprland keybinds cheatsheet modal |
| `toggleBinds` | Toggle Hyprland keybinds cheatsheet visibility |
...
The keybinds cheatsheet automatically parses your Hyprland configuration from `~/.config/hypr` and displays all keybinds organized into three columns:
