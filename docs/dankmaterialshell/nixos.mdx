...
DankMaterialShell can be installed on NixOS using the NixOS module or home-manager with a declarative configuration. This guide covers the flake-based installation method.
...
### 2. Import the NixOS/Home Module
...
If you're using the niri compositor, the home module provides additional integration options including automatic keybindings and startup configuration.
