...
The Settings UI provides **Show Over Fullscreen** toggles for DankBar, Dock, and
...
The Settings UI also has per-bar **Show Over Fullscreen** toggles. If this
...
layer. For example, a bar with **Show Over Fullscreen** enabled opens its
...
The Launcher settings page also has **Show Over Fullscreen**. If
