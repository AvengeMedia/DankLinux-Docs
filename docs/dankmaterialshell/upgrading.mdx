...
# Upgrading DankMaterialShell

This guide covers how to upgrade DankMaterialShell across different installation methods.
...
# or, upgrade all installed AUR/devel packages
paru -Sua
```

After the package upgrades, restart the shell:
