...
- **API Documentation**: See the [IPC documentation](/docs/dankmaterialshell/ipc) for search-related commands
...
- [DankMaterialShell Spotlight](/docs/dankmaterialshell/) - Learn about the integrated launcher
- [DMS Configuration](/docs/dankmaterialshell/configuration) - Configure search settings
- [IPC Commands](/docs/dankmaterialshell/ipc) - Programmatic search interface
