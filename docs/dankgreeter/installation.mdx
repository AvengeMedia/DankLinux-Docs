...
Build the `dms-greeter` package with `xbps-src` (see the [DMS installation guide](../dankmaterialshell/installation#void-linux) for the full build steps), then install and enable it:
