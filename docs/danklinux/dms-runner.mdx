...
| `dms ipc call ...` | Sends an IPC command. See the [IPC Command Reference](/docs/dankmaterialshell/ipc) for available targets. |
...
- **Scripting:** The CLI makes automation simple—wrap `dms ipc` commands inside shell scripts or systemd timers to toggle features on schedules.
