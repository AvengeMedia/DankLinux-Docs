...
- **Greeter:** Configure greetd via `dms greeter install` or edit `/etc/greetd/config.toml` manually. See the [Greeter documentation](/docs/dankmaterialshell/greeter) for theme syncing.
