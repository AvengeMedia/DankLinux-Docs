...
Notifications and credentials use XDG desktop portals. To sync [DankMaterialShell](../dankmaterialshell/) theme colors from the host, grant read access to the cache:
