...
Release notes for DankMaterialShell (DMS) v1.5.0. See the full release notes [blog](/blog).
...
**Full Changelog**: https://github.com/AvengeMedia/DankMaterialShell/compare/v1.5.0...origin/stable-1.5


## v1.5.x — "The Wolverine"
