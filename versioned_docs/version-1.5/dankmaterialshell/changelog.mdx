...
### Features
- DankCalendar has been released as a Flatpak on [Flathub](https://flathub.org/apps/com.danklinux.dankcalendar)!
...
**GitHub Release**: https://github.com/AvengeMedia/DankMaterialShell/releases/tag/v1.5.3
