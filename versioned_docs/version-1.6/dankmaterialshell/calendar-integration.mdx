...
:::tip[Try DankCalendar instead]
Setting up khal and vdirsyncer is very user-unfriendly and convoluted. [DankCalendar](../dankcalendar/) (`dcal`) is a standalone app that connects Local, Google, Microsoft, CalDAV, and iCloud calendars directly, with no vdirsyncer/khal required. This khal guide remains for users who prefer it.
:::
